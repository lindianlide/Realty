...
public interface WebsiteDao {
	...
	List<Macro> macroList(int macrochcategoryId);
	List<Macro> macroList(int pageNo, int pageSize, int macrochcategoryId);
	...
	List<Micro> microList(int microchcategoryId);
	List<Micro> microList(int pageNo, int pageSize, int microchcategoryId);
