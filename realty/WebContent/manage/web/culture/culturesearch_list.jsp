...
List<Culture> searchlist=(List<Culture>)session.getAttribute("culsearchlist");
%>
<% 
...
function insert()
{
	window.open('manage/web/culture/culture_add.jsp','middleFrame','top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
}
function search()
{
 ...
 <table id="mainpage" width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
	...
	<!-- 		 <td width="175" align="left">
			   <input name="button2" type="button" class="right-button07" value="添加住宅项目" onClick="insert()"/>
			 </td> -->	
		  </tr>
        </table></td>
      </tr>
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="35" colspan="6" class="tablestyle_title">企业文化列表</td>
                    </tr>
                  <tr>
                  ...
                  <tr align="center">
				    <td height="30" bgcolor="#FFFFFF"> <a href="manage/web/culture/culture_detail.jsp?culcategoryId=<%=searchlist.get(i).getCulcategoryId()%>&culture_id=<%=searchlist.get(i).getCultureId()%>" ><%=searchlist.get(i).getTitle()%></a></td>
                    <td bgcolor="#FFFFFF"><a href="manage/web/culture/culture_update.jsp?culcategoryId=<%=searchlist.get(i).getCulcategoryId()%>&culture_id=<%=searchlist.get(i).getCultureId()%>" >修改 </a>   <a href="WebsitemServlet?flag=15&culcategoryId=<%=searchlist.get(i).getCulcategoryId()%>&cultureId=<%=searchlist.get(i).getCultureId()%>" >删除</a></td>
                  </tr>
                  <%} %>
                </table></td>
              </tr>
