...
if(lawcategoryId==0)
	title="国家列表";
else if(lawcategoryId==1)
	title="山东省列表";
else if(lawcategoryId==2)
	title="青岛市列表";
else if(lawcategoryId==3)
	title="其他列表";
...
function insert()
{
	window.open('manage/web/law/law_add.jsp?lawcategoryId=<%=lawcategoryId%>','middleFrame','top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
}
function search()
{
...
function passpageNo(){
	...
	document.form.action="manage/web/law/law_list.jsp?lawcategoryId=<%=lawcategoryId%>&pageNo="+gopageNo;
	document.form.submit();
}
</SCRIPT>
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
                  ...
                  <tr align="center">
				    <td height="30" bgcolor="#FFFFFF"> <a href="manage/web/law/law_detail.jsp?lawcategoryId=<%=lawcategoryId%>&law_id=<%=pagelist.get(i).getLawId()%>" ><%=pagelist.get(i).getName()%></a></td>
                    <td bgcolor="#FFFFFF"><a href="manage/web/law/law_update.jsp?lawcategoryId=<%=lawcategoryId%>&law_id=<%=pagelist.get(i).getLawId()%>" >修改 </a>   <a href="WebsitemServlet?flag=7&lawcategoryId=<%=lawcategoryId%>&lawId=<%=pagelist.get(i).getLawId()%>">删除</a></td>
                  </tr>
                  <%} %>
                </table></td>
              </tr>
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="48%" align="right">[<a href="manage/web/law/law_list.jsp?lawcategoryId=<%=lawcategoryId %>&pageNo=1" class="right-font08">首页</a> | <a href="manage/web/law/law_list.jsp?lawcategoryId=<%=lawcategoryId %>&pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="manage/web/law/law_list.jsp?lawcategoryId=<%=lawcategoryId %>&pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="manage/web/law/law_list.jsp?lawcategoryId=<%=lawcategoryId %>&pageNo=<%=index%>" class="right-font08">末页</a>] 转至：</td>
