...
List<Research> searchlist=(List<Research>)session.getAttribute("researchsearchlist");
%>
<% 
...
function insert()
{
	window.open('manage/web/research/research_add.jsp','middleFrame','top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
}
function search()
{
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="35" colspan="6" class="tablestyle_title">研究发布列表</td>
                    </tr>
                  <tr>
                  ...
                  <tr align="center">
				    <td height="30" bgcolor="#FFFFFF"> <a href="manage/web/research/research_detail.jsp?reschcategoryId=<%=searchlist.get(i).getReschcategoryId()%>&research_id=<%=searchlist.get(i).getReschId()%>" ><%=searchlist.get(i).getTitle()%></a></td>
                    <td bgcolor="#FFFFFF"><a href="manage/web/research/research_update.jsp?reschcategoryId=<%=searchlist.get(i).getReschcategoryId()%>&research_id=<%=searchlist.get(i).getReschId()%>" >修改 </a>   <a href="WebsitemServlet?flag=11&reschcategoryId=<%=searchlist.get(i).getReschcategoryId()%>&researchId=<%=searchlist.get(i).getReschId()%>" >删除</a></td>
                  </tr>
                  <%} %>
                </table></td>
              </tr>
