...
List<Macro> searchlist=(List<Macro>)session.getAttribute("macrosearchlist");
%>
<% 
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="35" colspan="6" class="tablestyle_title">宏观数据列表</td>
                    </tr>
                  <tr>
                  ...
                  <tr align="center">
				    <td height="30" bgcolor="#FFFFFF"> <a href="manage/web/macro/macro_detail.jsp?macro_id=<%=searchlist.get(i).getMacroId()%>&macrocategoryId=<%=searchlist.get(i).getMacrocategoryId()%>" ><%=searchlist.get(i).getName()%></a></td>
                    <td bgcolor="#FFFFFF"><a href="manage/web/macro/macro_update.jsp?macro_id=<%=searchlist.get(i).getMacroId()%>&macrocategoryId=<%=searchlist.get(i).getMacrocategoryId()%>" >修改 </a>   <a href="WebsitemServlet?flag=7&macroId=<%=searchlist.get(i).getMacroId()%>&macrocategoryId=<%=searchlist.get(i).getMacrocategoryId()%>" >删除</a></td>
                  </tr>
                  <%} %>
                </table></td>
              </tr>
