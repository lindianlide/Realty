...
<link rel="stylesheet" rev="stylesheet" href="./css/web.css" type="text/css" media="all" />
 ...
 function passpageNo(){
		...
		document.form.action="manage/web/down/down_manages.jsp?category=<%=category%>&pageNo="+gopageNo;
        ...
        <tr>
          ...
          <table style="border:0px;"  width="100%" class="right-font08">
              <tr>
                ...
                <td style="border:0px;" width="48%" align="right">[<a href="manage/web/down/down_manages.jsp?category=<%=category%>&pageNo=1" class="right-font08">首页</a> | <a href="manage/web/down/down_manages.jsp?category=<%=category%>&pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="manage/web/down/down_manages.jsp?category=<%=category%>&pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="manage/web/down/down_manages.jsp?category=<%=category%>&pageNo=<%=index%>" class="right-font08">末页</a>] 转至：</td>
