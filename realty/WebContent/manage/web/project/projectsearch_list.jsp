...
List<Project> searchlist=(List<Project>)session.getAttribute("prosearchlist");
%>
<% 
...
function insert()
{
	window.open('manage/web/project/project_add.jsp','middleFrame','top=0,left=0,toolbar=no,menubar=no,scrollbars=no, resizable=no,location=no, status=no');
}
function search()
{
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="35" colspan="6" class="tablestyle_title">住宅项目列表</td>
                    </tr>
                  <tr>
                  ...
                  <tr align="center">
				    <td height="30" bgcolor="#FFFFFF"> <a href="manage/web/project/project_detail.jsp?procategoryId=<%=searchlist.get(i).getProcategoryId()%>&project_id=<%=searchlist.get(i).getProjectId()%>" ><%=searchlist.get(i).getTitle()%></a></td>
                    <td bgcolor="#FFFFFF"><a href="manage/web/project/project_update.jsp?procategoryId=<%=searchlist.get(i).getProcategoryId()%>&project_id=<%=searchlist.get(i).getProjectId()%>" >修改 </a>   <a href="WebsitemServlet?flag=3&procategoryId=<%=searchlist.get(i).getProcategoryId()%>&projectId=<%=searchlist.get(i).getProjectId()%>" >删除</a></td>
                  </tr>
                  <%} %>
                </table></td>
              </tr>
