...
List<Micro> searchlist=(List<Micro>)session.getAttribute("microsearchlist");
%>
<% 
          ...
          <td><table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td class="font42"><table width="100%" border="0" cellpadding="4" cellspacing="1" bgcolor="#464646" class="newfont03">
					                  ...
					                  <tr>
                    <td height="35" colspan="6" class="tablestyle_title">微观数据列表</td>
                    </tr>
                  <tr>
                  ...
                  <tr align="center">
				    <td height="30" bgcolor="#FFFFFF"> <a href="manage/web/micro/micro_detail.jsp?microId=<%=searchlist.get(i).getMicroId()%>&microcategoryId=<%=searchlist.get(i).getMicrocategoryId()%>" ><%=searchlist.get(i).getName()%></a></td>
                    <td bgcolor="#FFFFFF"><a href="manage/web/micro/micro_update.jsp?microId=<%=searchlist.get(i).getMicroId()%>&microcategoryId=<%=searchlist.get(i).getMicrocategoryId()%>" >修改 </a>   <a href="WebsitemServlet?flag=7&microId=<%=searchlist.get(i).getMicroId()%>&microcategoryId=<%=searchlist.get(i).getMicrocategoryId()%>" >删除</a></td>
                  </tr>
                  <%} %>
                </table></td>
              </tr>
