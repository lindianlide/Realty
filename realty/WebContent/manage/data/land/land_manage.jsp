...
List<Land> landList=landaction.findAll();
int pageSize=10;
int index=0;
...
List<Land> pagelist=landaction.findAllpage(pageNo, pageSize);
%>
<% 
...
function passpageNo(){ 
	...
	document.form.action="manage/data/land/land_manage.jsp?pageNo="+gopageNo;
...
<div id="search">
  <blockquote>
	...
	<%-- <a id="01" href="javascript:void(0);" onclick="bb(0,01)"><%=regionList.get(1).getRegionName()%></a> &nbsp;
