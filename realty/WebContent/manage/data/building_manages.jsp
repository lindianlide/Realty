...
int averagePrice=Integer.parseInt(searchchar2);
...
int introid=0;
int count=buildingaction.buildingCount(regionId, usageId, averagePrice,null);
...
List<Building> pagelist=buildingaction.buildingSearch(regionId, usageId, averagePrice,null,pageNo,pageSize);
%>
<% 
...
function passpageNo(){ 
	...
	document.form.action="manage/data/building_manages.jsp?searchchar[0]=<%=regionId %>&searchchar[1]=<%=usageId %>&searchchar[2]=<%=averagePrice%>&pageNo="+gopageNo;
					...
					if(buildintroList.get(j).getBuildingId()==pagelist.get(i).getBuildingId()){
						{
							introid=j;
		      			   ...
		      			   <tr>
		      			    <td><a href="manage/data/building_detail.jsp?buildingId=<%=pagelist.get(i).getBuildingId()%>"> <span><%=pagelist.get(i).getBuildingName()%></span></a></td>
        ...
        <tr>
          ...
          <table style="border:0px;"  width="100%" class="right-font08">
              <tr>
                ...
                <td style="border:0px;" width="48%" align="right">[<a href="manage/data/building_manages.jsp?pageNo=1&searchchar[0]=<%=regionId %>&searchchar[1]=<%=usageId %>&searchchar[2]=<%=averagePrice%>" class="right-font08">首页</a> | <a href="manage/data/building_manages.jsp?pageNo=<%=pageNo-1%>&searchchar[0]=<%=regionId %>&searchchar[1]=<%=usageId %>&searchchar[2]=<%=averagePrice%>" class="right-font08">上一页</a> | <a href="manage/data/building_manages.jsp?pageNo=<%=pageNo+1%>&searchchar[0]=<%=regionId %>&searchchar[1]=<%=usageId %>&searchchar[2]=<%=averagePrice%>" class="right-font08">下一页</a> | <a href="manage/data/building_manages.jsp?pageNo=<%=index%>&searchchar[0]=<%=regionId %>&searchchar[1]=<%=usageId %>&searchchar[2]=<%=averagePrice%>" class="right-font08">末页</a>] 转至：</td>
...
var averagePrice1=2+"<%=averagePrice%>";
