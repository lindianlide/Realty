...
List<Secondhouse> pagelist=secondaction.secondList(pageNo, pageSize);
%>
<% 
...
function passpageNo(){ 
	...
	document.form.action="manage/data/second/second_manage.jsp?pageNo="+gopageNo;
        ...
        <tr>
          ...
          <table style="border:0px;"  width="100%" class="right-font08">
              <tr>
                ...
                <td style="border:0px;" width="48%" align="right">[<a href="manage/data/second/second_manage.jsp?pageNo=1" class="right-font08">首页</a> | <a href="manage/data/second/second_manage.jsp?pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="manage/data/second/second_manage.jsp?pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="manage/data/second/second_manage.jsp?pageNo=<%=index%>" class="right-font08">末页</a>] 转至：</td>
