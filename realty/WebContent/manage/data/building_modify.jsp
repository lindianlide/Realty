...
String buildingAlias=request.getParameter("buildingAlias");
String regionId1=request.getParameter("regionId");
System.out.println("regionId1============"+regionId1);
ArrayList<Object> arrylist = new ArrayList<Object>();
arrylist.add(buildingName);
arrylist.add(buildingAlias);
arrylist.add(regionId1);
...
<div id="tab_area" class="tab_area_style">
     <iframe name="buildingone" id="buildingone"  class="content_area" src="manage/data/buildingdetail_modify.jsp?buildingId=<%=buildingId %>" frameborder="0" >
    </iframe>
   <iframe  name="buildingtwo" id="buildingtwo" src="manage/data/buildingaround_modify.jsp?buildintroId=<%=buildintroId %>&buildingId=<%=buildingId %>" frameborder="0" >
    </iframe>
    <iframe  name="buildingthree" id="buildingthree" src="manage/data/buildingfloor_list.jsp?buildingId=<%=buildingId %>" frameborder="0" >
    </iframe> 
     <iframe  name="buildingfour" id="buildingfour" src="manage/data/buildingmatch_modify.jsp?buildingId=<%=buildingId %>" frameborder="0" >
    </iframe>
</div>
</div>
