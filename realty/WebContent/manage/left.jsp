    ...
    <td valign="top"><table width="151" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td height="23" background="images/manage/home/main_47.gif" id="imgmenu1" class="menu_title" onMouseOver="this.className='menu_title2';" onClick="showsubmenu(1)" onMouseOut="this.className='menu_title';" style="cursor:hand">
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td width="18%">&nbsp;</td>
                <td width="82%" class="STYLE1">土地信息管理</td>
              </tr>
            </table></td>
          </tr>
          <tr>
                ...
                <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <table width="95%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3">
                      		<a id="0" href="manage/data/land/land_add.jsp" onClick="info(0)" target="middleFrame"> 录入土地信息</a>
                          </span></td>
                        </tr>
                    </table></td>
                  </tr>
                  <tr>
                    ...
                    <table width="95%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3">
              				 <a id="1" href="manage/data/land/land_manage.jsp" onClick="info(1)" target="middleFrame">管理土地信息</a>
                          </span></td>
                        </tr>
                    </table></td>
                  </tr>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="23" background="images/manage/home/main_47.gif" id="imgmenu2" class="menu_title" onmouseover="this.className='menu_title2';" onclick="showsubmenu(2)" onmouseout="this.className='menu_title';" style="cursor:hand"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="18%">&nbsp;</td>
                  <td width="82%" class="STYLE1">新房信息管理</td>
                </tr>
            </table></td>
          </tr>
          <tr>
                    ...
                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3">
                              <a id="2" href="manage/data/building_add.jsp" onClick="info(2)" target="middleFrame">录入新房信息</a>
                                </span></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          ...
                          <td height="23">
	                          <table width="95%" border="0" cellspacing="0" cellpadding="0">
	                              <tr>
	                                <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3">
	                                	<a id="3" href="manage/data/building_manage.jsp" onClick="info(3)" target="middleFrame">管理新房信息</a>
	                                </span></td>
	                              </tr>
	                          </table>
                          </td>
        ...
        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td height="23" background="images/manage/home/main_47.gif" id="imgmenu3" class="menu_title" onmouseover="this.className='menu_title2';" onclick="showsubmenu(3)" onmouseout="this.className='menu_title';" style="cursor:hand"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td width="18%">&nbsp;</td>
                  <td width="82%" class="STYLE1">二手房管理</td>
                </tr>
            </table></td>
          </tr>
          <tr>
                    ...
                    <td><table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
                        <tr>
                          ...
                          <td width="84%" height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3">
                               	 <a id="4" href="manage/data/second/second_add.jsp" onClick="info(4)" target="middleFrame">录入二手房信息</a>
                                </span></td>
                              </tr>
                          </table></td>
                        </tr>
                        <tr>
                          ...
                          <td height="23"><table width="95%" border="0" cellspacing="0" cellpadding="0">
                              <tr>
                                <td height="20" style="cursor:hand" onmouseover="this.style.borderStyle='solid';this.style.borderWidth='1';borderColor='#7bc4d3'; "onmouseout="this.style.borderStyle='none'"><span class="STYLE3">
                                <a id="5" href="manage/data/second/second_manage.jsp" onClick="info(5)" target="middleFrame">管理二手房信息</a>
                                </span></td>
                              </tr>
                          </table></td>
                        </tr>
