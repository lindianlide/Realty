...
<%@page import="com.realty.base.model.Law"%>
...
<%
 ...
 %>
 <%
 String lawcategoryId1=request.getParameter("gory");
 if(lawcategoryId1==null)
	 lawcategoryId1="1";
 int lawcategoryId=Integer.parseInt(lawcategoryId1);
 WebsiteAction website=new WebsiteAction();
 int pageSize=2;
 int index=0;
 int count=website.lawList(lawcategoryId).size();
 ...
 List<Law> pagelist=website.lawList(pageNo, pageSize,lawcategoryId);
 %>
	...
	<div id="panelfo-in2" >
	  <ul class="lmenu">
		<li style="margin-bottom:20px">
			<a href="laws.jsp?earth=aa&&gory=1" style="font-size:20px;color:#000;background:#EBEBEB">国家政策</a>
			<!-- <ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="laws.jsp?earth=aa&&gory=2" style="font-size:20px;color:#000;background:#EBEBEB">山东省政策</a>
			<!-- <ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="laws.jsp?earth=aa&&gory=3" style="font-size:20px;color:#000;background:#EBEBEB">青岛市政策</a>
		<!-- 	<ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="laws.jsp?earth=aa&&gory=4" style="font-size:20px;color:#000;background:#EBEBEB">其他</a>
			<!-- <ul class="level2">
	 ...
	 <% 
		 ...
		 {%>
             ...
             <div id="Layer6">
  				<div id="Layer7"><a href="laws.jsp?earth=bb&&lawid=<%=pagelist.get(i).getLawId()%>" ><%=pagelist.get(i).getName()%></a></div>
  				<div id="Layer8"><%=pagelist.get(i).getDate()%></div>
  					<div id="Layer9">
    				<div id="Layer10"><a href="laws.jsp?earth=bb&&lawid=<%=pagelist.get(i).getLawId()%>" >详情</a></div>
    				</div>
  			</div>
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="48%" align="right">[<a href="../dynpages/projects.jsp?earth=aa&gory=<%=lawcategoryId%>&pageNo=1" class="right-font08">首页</a> | <a href="../dynpages/projects.jsp?earth=aa&gory=<%=lawcategoryId %>&pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="../dynpages/projects.jsp?earth=aa&gory=<%=lawcategoryId %>&pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="../dynpages/projects.jsp?earth=aa&gory=<%=lawcategoryId %>&pageNo=<%=index%>" class="right-font08">末页</a>] </td>
		 ...
		 <%}
		 if("bb".equals(names)){
		  	int lawId =Integer.parseInt(request.getParameter("lawid"));
		     System.out.println(lawId);
		     WebsiteAction weba = new WebsiteAction();
		    List<Law> list2=weba.laws(lawId);
			 ...
			 <div>
                  ...
                  <div style="float:right;color:#000000;margin:10px 10px">时间： <%=list2.get(0).getDate()%></div>
                   ...
                   <%if(list2.get(0).getLawFile()!=null) {%>
                   <div style="color:#000000" >下载地址：<a href="down.jsp?filePath=<%=list2.get(0).getLawFile()%>"><%=list2.get(0).getName()%></a></div></div>
		 <% }
