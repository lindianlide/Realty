...
<%@page import="com.realty.base.model.Macro"%>
...
<%
 ...
 %>
 <%
 String maccategoryId1=request.getParameter("gory");
 if(maccategoryId1==null)
	 maccategoryId1="1";
 int maccategoryId=Integer.parseInt(maccategoryId1);
 WebsiteAction website=new WebsiteAction();
 int pageSize=2;
 int index=0;
 int count=website.newsList(maccategoryId).size();
 ...
 List<Macro> pagelist=website.macroList(pageNo, pageSize,maccategoryId);
 %>
	...
	<div id="panelfo-in2" >
	  <ul class="lmenu">
		<li style="margin-bottom:20px">
			<a href="macro.jsp?earth=aa&&gory=0" style="font-size:20px;color:#000;background:#EBEBEB">市场动态</a>
			<!-- <ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="macro.jsp?earth=aa&&gory=1" style="font-size:20px;color:#000;background:#EBEBEB">政策信息</a>
			<!-- <ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="macro.jsp?earth=aa&&gory=2" style="font-size:20px;color:#000;background:#EBEBEB">土地咨询</a>
		<!-- 	<ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="macro.jsp?earth=aa&&gory=3" style="font-size:20px;color:#000;background:#EBEBEB">公司动态</a>
			<!-- <ul class="level2">
	 ...
	 <% 
		 ...
		 {%>
             ...
             <div id="Layer6">
  				<div id="Layer7"><a href="macro.jsp?earth=bb&&macroid=<%=pagelist.get(i).getMacroId()%>" ><%=pagelist.get(i).getName()%></a></div>
  				<div id="Layer8"><%=pagelist.get(i).getDate()%></div>
  					<div id="Layer9">
    				<div id="Layer10"><a href="macro.jsp?earth=bb&&macroid=<%=pagelist.get(i).getMacroId()%>" >详情</a></div>
    				</div>
  			</div>
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="48%" align="right">[<a href="../dynpages/news.jsp?earth=aa&gory=<%=maccategoryId%>&pageNo=1" class="right-font08">首页</a> | <a href="../dynpages/news.jsp?earth=aa&gory=<%=maccategoryId %>&pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="../dynpages/news.jsp?earth=aa&gory=<%=maccategoryId %>&pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="../dynpages/news.jsp?earth=aa&gory=<%=maccategoryId %>&pageNo=<%=index%>" class="right-font08">末页</a>] </td>
		 ...
		 <%}
		 if("bb".equals(names)){
		  	int marcocategoryId =Integer.parseInt(request.getParameter("macroid"));
		     WebsiteAction weba = new WebsiteAction();
		     List<Macro> list2=weba.macroList(marcocategoryId);
		     %>
			 <div>
