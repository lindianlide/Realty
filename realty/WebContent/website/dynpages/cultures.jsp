...
<%@page import="com.realty.base.model.Culture"%>
...
<%
 ...
 int pageSize=2;
 int index=0;
 int count=website.cultureList(procategoryId).size();
 ...
 List<Culture> pagelist=website.cultureList(pageNo, pageSize,procategoryId);
 %>
	...
	<div id="panelfo-in2" >
	  <ul class="lmenu">
		<li style="margin-bottom:20px">
			<a href="cultures.jsp?earth=aa&&gory=1" style="font-size:20px;color:#000;background:#EBEBEB">企业文化</a>
			<!-- <ul class="level2">
		...
		<!-- <li style="margin-bottom:20px">
			<a href="cultures.jsp?earth=aa&&gory=1" style="font-size:20px;color:#000;background:#EBEBEB">政策信息</a>
			<ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="cultures.jsp?earth=aa&&gory=2" style="font-size:20px;color:#000;background:#EBEBEB">土地咨询</a>
			<ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="cultures.jsp?earth=aa&&gory=3" style="font-size:20px;color:#000;background:#EBEBEB">公司动态</a>
			<ul class="level2">
	 ...
	 <% 
		 ...
		 {%>
             ...
             <div id="Layer6">
  				<div id="Layer7"><a href="cultures.jsp?earth=bb&&cultureid=<%=pagelist.get(i).getCultureId()%>" ><%=pagelist.get(i).getTitle()%></a></div>
  				<div id="Layer8"><%=pagelist.get(i).getData()%></div>
  					<div id="Layer9">
    				<div id="Layer10"><a href="cultures.jsp?earth=bb&&cultureid=<%=pagelist.get(i).getCultureId()%>" >详情</a></div>
    				</div>
  			</div>
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="48%" align="right">[<a href="../dynpages/cultures.jsp?earth=aa&gory=<%=procategoryId%>&pageNo=1" class="right-font08">首页</a> | <a href="../dynpages/cultures.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="../dynpages/cultures.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="../dynpages/cultures.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=index%>" class="right-font08">末页</a>] </td>
		 ...
		 <%}
		 if("bb".equals(names)){
		  	int cultureId =Integer.parseInt(request.getParameter("cultureid"));
		     WebsiteAction weba = new WebsiteAction();
		    List<Culture> list2=weba.culture(cultureId);
