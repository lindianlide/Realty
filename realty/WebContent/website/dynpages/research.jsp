...
<%@page import="com.realty.base.model.Research"%>
...
<%
 ...
 int pageSize=2;
 int index=0;
 int count=website.researchList(procategoryId).size();
 ...
 List<Research> pagelist=website.researchList(pageNo, pageSize,procategoryId);
 %>
	...
	<div id="panelfo-in2" >
	  <ul class="lmenu">
		<li style="margin-bottom:20px">
			<a href="research.jsp?earth=aa&&gory=0" style="font-size:20px;color:#000;background:#EBEBEB">市场报告</a>
			<!-- <ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="research.jsp?earth=aa&&gory=1" style="font-size:20px;color:#000;background:#EBEBEB">课题研究</a>
			<!-- <ul class="level2">
	 ...
	 <% 
	 	...
	 	if("aa".equals(names)){	  	 
			 ...
			 {%>
	             ...
	             <div id="Layer6">
	  				<div id="Layer7"><a href="research.jsp?earth=bb&&researchid=<%=pagelist.get(i).getReschId()%>" ><%=pagelist.get(i).getTitle()%></a></div>
	  				<div id="Layer8"><%=pagelist.get(i).getDate()%></div>
	  					<div id="Layer9">
	    				<div id="Layer10"><a href="news.jsp?earth=bb&&newsid=<%=pagelist.get(i).getReschId()%>" >详情</a></div>
	    				</div>
	  			</div>
	        ...
	        <tr>
	          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
	              <tr>
	                ...
	                <td width="48%" align="right">[<a href="../dynpages/research.jsp?earth=aa&gory=<%=procategoryId%>&pageNo=1" class="right-font08">首页</a> | <a href="../dynpages/research.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="../dynpages/research.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="../dynpages/research.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=index%>" class="right-font08">末页</a>] </td>
		 ...
		 if("bb".equals(names)){
		    ...
		    List<Research> list2=weba.researchs(researchId);
		     %>
			 <div>
