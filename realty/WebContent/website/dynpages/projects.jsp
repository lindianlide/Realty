...
<%
 ...
 System.out.print(procategoryId);
	...
	<div id="panelfo-in2" >
	  <ul class="lmenu">
		<li style="margin-bottom:20px">
			<a href="projects.jsp?earth=aa&&gory=1" style="font-size:20px;color:#000;background:#EBEBEB">住宅</a>
			<!-- <ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="projects.jsp?earth=aa&&gory=2" style="font-size:20px;color:#000;background:#EBEBEB">商业</a>
			<!-- <ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="projects.jsp?earth=aa&&gory=3" style="font-size:20px;color:#000;background:#EBEBEB">工业</a>
		<!-- 	<ul class="level2">
		...
		<li style="margin-bottom:20px">
			<a href="projects.jsp?earth=aa&&gory=4" style="font-size:20px;color:#000;background:#EBEBEB">其他</a>
			<!-- <ul class="level2">
	 ...
	 <% 
		 ...
		 {%>
             ...
             <div id="Layer6">
  				<div id="Layer7"><a href="projects.jsp?earth=bb&&projectid=<%=pagelist.get(i).getProjectId()%>" ><%=pagelist.get(i).getTitle()%></a></div>
  				<div id="Layer8"><%=pagelist.get(i).getDate()%></div>
  					<div id="Layer9">
    				<div id="Layer10"><a href="projects.jsp?earth=bb&&projectid=<%=pagelist.get(i).getProjectId()%>" >详情</a></div>
    				</div>
  			</div>
        ...
        <tr>
          <td height="33"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" class="right-font08">
              <tr>
                ...
                <td width="48%" align="right">[<a href="../dynpages/projects.jsp?earth=aa&gory=<%=procategoryId%>&pageNo=1" class="right-font08">首页</a> | <a href="../dynpages/projects.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=pageNo-1%>" class="right-font08">上一页</a> | <a href="../dynpages/projects.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=pageNo+1%>" class="right-font08">下一页</a> | <a href="../dynpages/projects.jsp?earth=aa&gory=<%=procategoryId %>&pageNo=<%=index%>" class="right-font08">末页</a>] </td>
		 ...
		 if("bb".equals(names)){
		    ...
		    List<Project> list2=weba.projects(projectId);
		     %>
			 <div>
                  ...
                  <div style="float:right;color:#000000;margin:10px 10px">时间： <%=list2.get(0).getDate()%></div>
                   ...
                   <div style="width:870px;color:#000000;margin:40px 10px"><%=list2.get(0).getContents()%></div>
                    <%if(list2.get(0).getProFile()!=null) {%>
                   <div style="color:#000000" >下载地址：<a href="down.jsp?filePath=<%=list2.get(0).getProFile()%>"><%=list2.get(0).getTitle()%></a></div></div>
		 <%}
