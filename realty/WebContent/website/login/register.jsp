...
<%@page import="com.realty.base.servlet.MemberServlet" %>
...
return false;
   ...
   <body class="home">
     ...
     <form id=form1 name="form1" method="post" action="MemberAdd?flag=1" onsubmit="check()" >
<table>
<tr>
<td>
用户名：
...
<td>
<input id="membername" type="text" name="membername" onblur="checkname()">
...
<td>
<input id="email" type="text" name="email" onblur="">
...
<td>
<input id="question" type="text" name="question" onblur="">
...
<td>
<input id="answer" type="text" name="answer" onblur="">
<div id="div5" style="display:inline">
</div>
</td>
</tr>
