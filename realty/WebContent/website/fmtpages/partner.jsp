    ...
    <script type="text/javascript">
	 ...
	 if(name=="qy"){
    	 document.onreadystatechange = function () {   
 	        if(document.readyState=="complete") {          
 	        	var namestr = document.getElementById("abcde");   	           
 	            var aerthstr = "<p align='center'>政府机构</p><p>东部价值观：决不为一时的利益损失我们永久的信誉;勤勤恳恳工作，踏踏实实赚钱</p><p>东部服务观： 专业、真诚、高效</p><p>东部人才观： 给员工提供广阔的发展平台、良好的薪金待遇、完善的培训教育体系及快乐的工作氛围</p><p>东部发展观： 做知名的专业性、综合性房地产估价与投资咨询机构</p><p>东部经营理念： 以人才和技术为基础，提供超值可信的服务</p><p>估价师执业理念： 独立、诚信、创新</p>";
 	            namestr.innerHTML = aerthstr;
 	         }   
 	     };
     }  
	 if(name=="pg"){
    	 document.onreadystatechange = function () {   
 	        if(document.readyState=="complete") {          
 	        	var namestr = document.getElementById("abcde");   	           
 	            var aerthstr = "<p align='center'>企业和个人</p><p align='center'><img  src='/realty/images/website/yyzz.jpg'></p>";
 	            namestr.innerHTML = aerthstr;
 	         }   
 	     };
     }  
...
<div class="marqueeSized">  </div> 
	<div id="panelfo-in2" >
	  <ul class="lmenu">
			<li><a href="partner.jsp?earth=db">金融机构</a></li>	
			<li><a href="partner.jsp?earth=qy">政府机构</a></li>	
			<li><a href="partner.jsp?earth=pg">企业和个人</a></li>		
			
			</ul>
	</div>
	  <div id="panelfo-in3">
	  <font color="blue">合作伙伴：</font><br/>
