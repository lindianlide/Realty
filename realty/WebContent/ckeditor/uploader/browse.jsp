...
<%
	...
	String clientPath = "ckeditorpic/" + type;
	// String clientPath=this.getServletConfig().getServletContext().getInitParameter("ckeditorpic")+ type;
	//String clientPath =  "E:/ckeditorpic/" + type;
