	...
	for (FileItem item : fileItemsList) {
		if (!item.isFormField()) {
			...
			//String clientPath = "ckeditor/uploader/upload/" + type + fileName;
			  String clientPath = "ckeditorpic/" + type + fileName;
			// String clientPath=this.getServletConfig().getServletContext().getInitParameter("ckeditorpic")+ type + fileName;	
			 //String clientPath = "E:/ckeditorpic/" + type + fileName;
			//保存文件到服务器上
